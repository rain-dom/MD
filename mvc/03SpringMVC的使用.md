...
![](E:\deng\deng\MD\image\拦截器执行结果.png)
...
![image-20200313182213954](E:\deng\deng\MD\image\多个拦截器执行顺序.png)

调整两个拦截器的配置顺序：

![image-20200313182350929](E:\deng\deng\MD\image\多个拦截器执行顺序2.png)
...
![image-20200313190146352](E:\deng\deng\MD\image\拦截器跟过滤器的执行流程.png)

![image-20200313190309273](E:\deng\deng\MD\image\拦截器和过滤器的包含关系.png)
...
![image-20200313193757666](E:\deng\deng\MD\image\国际化1.png)

![image-20200313193823121](E:\deng\deng\MD\image\国际化2.png)

![image-20200313194137103](E:\deng\deng\MD\image\国际化3.png)

通过图片能够发现，默认调用的是org.springframework.web.servlet.i18n.AcceptHeaderLocaleResolver类

![image-20200313194436614](E:\deng\deng\MD\image\国际化4.png)
...
![image-20200313204210754](E:\deng\deng\MD\image\异常处理实现的子类.png)

在容器启动好，进入DispatcherServlet之后，会对HandlerExceptionResolver进行初始化操作：

![image-20200313204557902](E:\deng\deng\MD\image\异常初始化.png)
